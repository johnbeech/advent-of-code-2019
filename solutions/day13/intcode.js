...
function saveInputToPosition ({ id, memory, position, mode1, inputs, inputSignal, base }) {
...
function executeProgram ({ id, memory, position, inputs, outputs, outputSignal, inputSignal, base }) {
  ...
  try {
    ...
    return opcodes[opcode]({ id, memory, position, inputs, outputs, mode1, mode2, mode3, outputSignal, inputSignal, base })
  } catch (ex) {
...
async function compute ({ instructions, inputs = [], outputs = [], outputSignal, inputSignal, base = 0, id }) {
  ...
  function stepProgram () {
    do {
      ...
      newPosition = executeProgram({ id, memory, position, inputs, outputs, outputSignal, inputSignal, base: basePointer })
